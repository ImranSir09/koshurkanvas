...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header
      id="app-main-header"
      className="w-full bg-white border-b border-stone-300 px-2 sm:px-4 flex items-center justify-between gap-2 select-none z-30 shrink-0 shadow-2xs backdrop-blur-md relative"
      style={{
        paddingTop: 'max(env(safe-area-inset-top, 0px), 0.4rem)',
